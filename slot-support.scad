...
module cartridge_slot_support(height, wall_thickness) {
  difference() {
    translate([
      ...
      - wall_thickness - cartridge_slot_tolerance() - cartridge_engraving_depth() - cartridge_wall_thickness() - cartridge_pcb_front_clearance() - cartridge_pcb_tolerance() - cartridge_pcb_thickness() - cartridge_pcb_tolerance() - cartridge_connector_stand_height() - cartridge_connector_pin_height() / 2,
      - height,
    ]) {
      cube([
